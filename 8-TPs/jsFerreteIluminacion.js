...
“FelipeLamparas” se hace un descuento del 10 % y 
si es de otra marca un 5%.

E.	Si el importe final con descuento suma 
más de $120  se debe sumar un 10% de ingresos 
brutos en informar del impuesto con el siguiente 
mensaje:
		...
		else
		{
			...
			else
			{
				...
				if (marca != "ArgentinaLuz" && cantidad == 5)
				{
					...
					precioDescuento = precioSinDescuento * 0.3;
